...
CALL %JMETER_HOME%\bin\jmeter.bat -n -t %TEST_HOME%\suspenderProducaoEstagios.jmx -JHOST=%HOST% -JPORT=%PORT% -JUSER=%USER% -JPASS=%PASS% -JLOGDIR=%TEST_HOME%
...
CALL %JMETER_HOME%\bin\jmeter.bat -n -t %TEST_HOME%\apontamentoMovimentoEtiquetas.jmx -JHOST=%HOST% -JPORT=%PORT% -JUSER=%USER% -JPASS=%PASS% -JLOGDIR=%TEST_HOME%
...
CALL %JMETER_HOME%\bin\jmeter.bat -n -t %TEST_HOME%\cancelamentoApontamentoOpComReserva.jmx -JHOST=%HOST% -JPORT=%PORT% -JUSER=%USER% -JPASS=%PASS% -JLOGDIR=%TEST_HOME%

CALL %JMETER_HOME%\bin\jmeter.bat -n -t %TEST_HOME%\opManual.jmx -JHOST=%HOST% -JPORT=%PORT% -JUSER=%USER% -JPASS=%PASS% -JLOGDIR=%TEST_HOME%
